                ...
                <div className="media-left">
                  <a href="#">
                    <img
                      ...
                      src="./src/Shoping_cart/images/pizza.jpg"
                      alt="pizza"
                    />
                  </a>
                </div>
              ...
              <div className="media product">
                <div className="media-left">
                  <a href="#">
                    <img
                      className="media-object"
                      src="./src/Shoping_cart/images/Hamburger.jpg"
                      alt="Humberger"
                    />
                  </a>
                </div>
              ...
              <div className="media product">
                <div className="media-left">
                  <a href="#">
                    <img
                      className="media-object"
                      src="./src/Shoping_cart/images/bread.jpg"
                      alt="pizza"
                    />
                  </a>
                </div>
              ...
              <div className="media product">
                <div className="media-left">
                  <a href="#">
                    <img
                      className="media-object"
                      src="./src/Shoping_cart/images/Cake.jpg"
                      alt="pizza"
                    />
                  </a>
                </div>
